# PrimeNumbers - Contribution Guide

## How to Contribute

1. **Fork the Repository**
   - Fork the PrimeNumbers repository to your GitHub account.

2. **Clone the Repository**
   - Clone the forked repository to your local environment:
     ```
     git clone https://github.com/gabriel-logan/PrimeNumbers.git
     ```
...
By contributing to PrimeNumbers, you agree that your contributions will be licensed under the MIT license. Make sure you're familiar with the terms of this license.
